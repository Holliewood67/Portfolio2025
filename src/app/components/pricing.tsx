...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="w-full bg-gray-400/25 py-16 px-4">
      <div ref={ref} className={inView ? 'slide-top max-w-5xl mx-auto' : 'opacity-0 max-w-5xl mx-auto'}>
        ...
        <div className="bg-gray-700/50 rounded-xl p-6 mb-12 shadow-black shadow-lg">
        ...
        <div className="bg-gray-700/50 rounded-xl p-6 mb-12 shadow-black shadow-lg">
          ...
          <ul className="text-gray-100 text-lg list-disc list-inside space-y-3">
            <li><strong>Event Calendar Integration</strong> – +$50  
              <br /><span className="text-sm text-gray-300">Sync with Google Calendar to auto-display upcoming events.</span></li>
            <li><strong>Photo Gallery or Video Header</strong> – +$25–$50  
              <br /><span className="text-sm text-gray-300">Highlight your space or vibe with rich visuals.</span></li>
            <li><strong>Simple Merch Store Setup</strong> – +$100  
              <br /><span className="text-sm text-gray-300">Includes Ko-fi, Shopify, or other third-party integration.</span></li>
            <li><strong>Domain & Hosting Setup</strong> – Free  
              <br /><span className="text-sm text-gray-300">I&apos;ll help you get your custom domain and hosting squared away.</span></li>
          </ul>
        </div>

        <div className="bg-gray-700/50 rounded-xl p-6 shadow-black shadow-lg">
          ...
          <ul className="mt-4 list-disc list-inside text-gray-100 text-lg space-y-2">
